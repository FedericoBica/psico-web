...
export const Contacto = () => {
  ...
  const handleWhatsAppSend = (e: React.FormEvent) => {
    ...
    const url = `https://wa.me/59897454505?text=${encodeURIComponent(texto)}`;
        ...
        <div className="bg-white/15 border border-white/20 rounded-3xl p-8">
          ...
          <form onSubmit={handleWhatsAppSend} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input 
              ...
              className="bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder:text-white/40 text-sm focus:outline-none focus:border-white/50 transition-all" 
            />
            <input 
              type="email" 
            ...
            <textarea 
              ...
              className="sm:col-span-2 bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder:text-white/40 text-sm focus:outline-none focus:border-white/50 transition-all resize-none" 
            />
            <button 
              type="submit"
